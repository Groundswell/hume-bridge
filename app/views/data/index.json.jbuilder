json.array!(@data_points.to_a) do |data_point|
	...
	json.acceleration_magnitude self.acceleration_vector_length,
	...
	json.acceleration_minus_gravity_xaxis self.corrected_acceleration_xaxis,
	json.acceleration_minus_gravity_yaxis self.corrected_acceleration_yaxis,
	json.acceleration_minus_gravity_zaxis self.corrected_acceleration_zaxis,
	json.acceleration_minus_gravity_magnitude self.corrected_acceleration_vector_length,
end
